...
**See also**: [ascd.org](https://www.ascd.org/blogs/profile-of-an-ai-ready-graduate) 
...
## 📝 6 Core Roles of Students When Interacting with AI Chatbot, According to ascd.org
  ...
  3. **Synthesizer:** *Students know how to use AI to synthesize, remix, and refine information into formats and levels of complexity that best meet their unique needs and capabilities.*
  4. **Problem Solver:** *Students know how to use AI as a brainstorming partner to generate new ideas and explore a wide range of possibilities.*
  5. **Connector:** *Students know how to use AI to increase human collaboration, including overcoming language barriers and finding common ground among divergent perspectives.*
  6. **Storysteller:** *Students know how to use AI to present and communicate complex ideas through text, image, audio, video, and other media.*
